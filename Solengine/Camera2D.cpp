...
namespace Solengine
{
	Camera2D::Camera2D() : _position(0.0f, 0.0f), _cameraMatrix(1.0f), _orthoMatrix(1.0f), _scale(1.0f), _needsMatrixUpdate(1), _screenWidth(500), _screenHeight(500)
	{
	}
	...
	bool Camera2D::isBoxInView(const glm::vec2& position, const glm::vec2& dimensions)
	{
		...
		glm::vec2 distVec = centrePos - _position;
