...
{                               
	...
	glm::vec2 centrePos = _position + glm::vec2(AGENT_RADIUS);
...
bool Agent::collisionWithAgent(Agent* agent)
{
	...
	glm::vec2 centrePosA = _position + glm::vec2(AGENT_RADIUS);
...
void Agent::draw(Solengine::SpriteBatch& _spriteBatch)
{
